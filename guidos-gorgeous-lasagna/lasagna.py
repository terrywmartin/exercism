...
def preparation_time_in_minutes(num_of_layers):
    ...
    This functions takes a number representing the number of layers and calculations the total number
    of minutes spent making the lasagna.
    """
...
def elapsed_time_in_minutes(num_of_layers, elapsed_bake_time):
    ...
    This function takes two number representing the number of layers and the time already spent
